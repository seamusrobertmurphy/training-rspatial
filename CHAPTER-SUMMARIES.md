...
**17. Remote-Sensing MRV and Verification Checks.** Equal-area validation-plot sampling, map-vs-field RMSE/bias/CI, the 20/10 eligibility test, and geometry-validity and area de-duplication checks. *acr-remote-sensing-demo, area-verification, land-eligibility-…-VM0047.*
...
lidar-forestry · allometric-model-validation · VM0010-starter-template · acr-remote-sensing-demo · area-verification · land-eligibility-VM0047 · darkwoods_wildfire/beetles · wildfire-fuel-mapping-CFFDRS-2.0 · IPCC-wildfire-emissions · enhanced-forest-inventory (assessment + pipeline) · map-templates · GPS-training-material · survey-tools · (gisborne, la-ronge, ash-dieback methods folded into the LiDAR chapter).
...
- **Jurisdictional REDD+ case studies** — `public-jurisdictional-data`, `TREES-bolivia`, `TREES-ecuador` as a worked activity-data / ART-TREES module.
