...
| 2 | **Vector data** — points, lines, polygons, shapefiles, geometry types, attributes & support, spatial operations | **Area checks** — validity, overlap reconciliation, area audit report | area-verification, public-jurisdictional-data, alma, hiawatha |
