...
|---|---|---|---|
| K1 | **Area checks** | area-verification, public-jurisdictional-data, public-disturbance-data, public-boundary-data | geometry validity, overlays, area reconciliation, audit reporting (flextable→Word) |
